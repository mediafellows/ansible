...
# TODO: switch back to upstream version (delete from here) as soon
# https://github.com/ansible/ansible-modules-core/issues/3404 is resolved
...
def main():
  ...
  argument_spec.update(dict(
      ...
      # Only here for this fix, once this has been resolved we can use upstream again:
